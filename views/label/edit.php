...
$this->title = Yii::t('app', 'Edit label'); ?>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title"><?= Yii::t('app', 'Edit label'); ?></h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <? if ($model->logo) {
                                ...
                                echo "    <div>";
                                echo Html::img('@web/image/label/' . $model->id . '/' . $model->logo, ['style' => 'max-width: 180px; max-height: 150px;']);
                                echo "    </div>";
                                echo "    <div>";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?
                            $datas = ArrayHelper::map(\app\models\Label_form::find()->where("compilations_label='yes' AND label_name!='" . $model->label_name . "'")->all(), 'id', 'label_name');
                        ...
                        <div class="col-md-12" style="display: flex;width: 100%;flex-wrap: wrap;">
                            <div class="form-group field-label_form-genre bmd-form-group" style="width: 90%;">
                                ...
                                <input type="hidden" class="form-control" id="label_form-genre" required
                                       name="Label_form[genre]" value="<?= htmlspecialchars($model->genre); ?>"
                                       maxlength="255" aria-invalid="false">
                                <input type="text" data-id="" id="genre" class="form-control" maxlength="255"
                                       aria-invalid="false">
                                <div class="col-lg-8" style="color:red;"><p class="help-block help-block-error"
                                                                            style="display: none;"
                                                                            id="genre_error"><?= Yii::t('app', 'Genre cannot be blank.'); ?></p>
                                </div>
                                <div class="col-lg-8" style="color:red;"><p class="help-block help-block-error"
                                                                            style="display: none;"
                                                                            id="mass_genre_error"><?= Yii::t('app', 'Maximum three genres'); ?></p>
                                </div>
                            </div>
                    ...
                    <button type="submit"
                            class="btn btn-primary pull-right"><?= Yii::t('app', 'Edit label'); ?></button>
